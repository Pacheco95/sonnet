...
# Clang and GCC emit incompatible .gcno formats; with Clang, gcovr has to drive llvm-cov.
set(_gcov_args "")
if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  string(REGEX MATCH "^[0-9]+" _clang_major "${CMAKE_CXX_COMPILER_VERSION}")
  find_program(LLVM_COV_EXECUTABLE NAMES "llvm-cov-${_clang_major}" llvm-cov REQUIRED)
