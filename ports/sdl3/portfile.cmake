...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DSDL_TESTS=OFF
        # Sonnet overlay: the X11 extensions an editor needs stay on. SDL loads their libraries at
        # run time, so only the headers are needed to build (docs/build.md, "Continuous integration").
        # XInput2 gives relative mouse mode and raw motion, Xcursor the system cursor shapes, Xfixes
        # cursor confinement, XRandR display modes and DPI, XScrnSaver the screensaver inhibit.
        -DSDL_X11_XCURSOR=ON
        -DSDL_X11_XDBE=OFF
        -DSDL_X11_XFIXES=ON
        -DSDL_X11_XINPUT=ON
